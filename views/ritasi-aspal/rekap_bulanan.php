...
<a class="btn" href="" style="color:black;background-color:#B3E5FC">3 BULAN TERAKHIR</a>
...
<?php 
$sql = "select distinct monthname(tanggal) as bulan, month(tanggal) as b, year(tanggal) as tahun from ritasi_aspal
...
$params = array_merge(["ritasi-aspal/rekap-bulanan"], $arrayParams);
...
'action' => ['ritasi-aspal/detail'], 'method'=>'GET',
		]); ?>
<table>
	<tr>
		<td></td>
		...
		$params = array_merge(["ritasi-aspal/excel"], $arrayParams);
		...
		?>
				<tr >
					...
					<?php echo ($model['keterangan_berangkat']);?>
						...
						<td>
							<a class="btn btn-detail"  href="<?php echo Yii::$app->urlManager->createUrl(['ritasi-aspal/detail', 'id'=>$id, 'tanggal'=>'-', 'bulan'=>$bulan]);?>" style="color:white;background-color:#01579B">DETIL</a>
