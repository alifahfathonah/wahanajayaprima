...
<a href="<?php echo Yii::$app->urlManager->createUrl(['keuangan/sub-harian', 'id'=>$proyek->id]);?>"><?php echo $proyek->nama_proyek;?></a>
</div>
...
<div style="background-color:#B3E5FC;border:1px solid black;padding:10px;margin-bottom:8px;">
<a href="<?php echo Yii::$app->urlManager->createUrl(['keuangan/sub-harian', 'id'=>$proyek->id]);?>"><?php echo $proyek->nama_basecamp;?></a>
</div>
