...
<br/>
	...
	($a,['prompt'=>'-Pilih Basecamp-', 'required'=>'required']);*/
	?>
...
<script>
	$(document).ready(function()
	{
		...
		$("#kendaraanritasiaspal-id_basecamp").change(function(){
			$("#list").html("");
			var id = $(this).val();
			if(id != ""){
				$.ajax({
					method:"GET",
					url:'<?php echo Yii::$app->urlManager->createUrl('kendaraan-ritasi-aspal/list'); ?>',	
					dataType: 'json',					
					cache:false,
					async:false,
					data: ({ 
