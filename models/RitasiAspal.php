...
/**
 * This is the model class for table "ritasi_aspal".
 *
 ...
 */
class RitasiAspal extends \yii\db\ActiveRecord
{
	public $no_polisi, $nama_basecamp, $nama_proyek, $bulan, $b;
	public $tahun;
    ...
    {
        return [
            [['id_kendaraan', 'asal', 'tujuan', 'jam_berangkat', 'menit_berangkat', 'aspal', 'ukuran', 'satuan', 'keterangan_berangkat'], 'required'],
            ...
            [['aspal', 'ukuran', 'satuan', 'created_by', 'edited_by'], 'string', 'max' => 100]
        ];
    }
