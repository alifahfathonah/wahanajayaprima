...
/**
 * RitasiAspalSearch represents the model behind the search form about `app\models\RitasiAspal`.
 */
class RitasiAspalSearch extends RitasiAspal
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['tanggal', 'aspal', 'ukuran', 'satuan', 'keterangan_berangkat', 'keterangan_tiba', 'created_by', 'created_date', 'edited_by', 'edited_date'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'aspal', $this->aspal])
