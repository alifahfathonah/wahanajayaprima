...
/**
 * KendaraanRitasiAspalSearch represents the model behind the search form about `app\models\KendaraanRitasiAspal`.
 */
class KendaraanRitasiAspalSearch extends KendaraanRitasiAspal
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = KendaraanRitasiAspal::find();
